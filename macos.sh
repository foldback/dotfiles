...
# Also stops your Mac from contacting Apple for time corrections
...
# Light extra pressure to register second level click
...
# Biggest size Dock items that still use reduced spacing
...
# Set $HOME/Downloads as the default download directory
defaults write org.m0k.transmission DownloadLocationConstant -bool true

# Automatically load .torrent files in $HOME/Downloads
...
echo "macOS configured. Restart to have all changes take effect!"
